...
{
    cout<<"Test add occurrences"<<endl;
    Bag b;
    b.add(-5);
    b.add(8);
    b.add(1);
    ...
    assert(b.nrOccurrences(0) == 0);
    assert(b.search(0) == false);
    b.addOccurrences(2, 0);
    assert(b.search(0) == true);
    assert(b.nrOccurrences(0) == 2);
    b.addOccurrences(5, -5);
    assert(b.nrOccurrences(-5) == 6);
    b.addOccurrences(1, 4);
    assert(b.nrOccurrences(4) == 2);
    try {
        b.addOccurrences(-3, 6);
        assert(false);
    }
    catch (exception&) {
        assert(true);
...
{
    cout<<"Test remove iterator"<<endl;
    Bag b;
    BagIterator it = b.iterator();
    assert(it.valid() == false);
    b.add(8);
